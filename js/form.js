...
class contato {
    constructor(nome, email, telefone, tipo, mensagem, aceitouTermos, aceitouNewletter){
        this.nome = nome,
        this.email = email,
        ...
        this.aceitouNewletter = aceitouNewletter
    }
};
...
function Post(form) {
    ...
    if(!termosCheckbox.checked){
        alert("Por favor, aceite os Termos e Condições para enviar formuçláRIOO");
        return false;
    }
